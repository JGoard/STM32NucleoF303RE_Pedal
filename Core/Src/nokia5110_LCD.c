...
void LCD_PrintInit(){
  LCD_print("Josh's", 22, FIRST_ROW);
  LCD_print("STM32 Nucleo", 4, SECOND_ROW);
  // LCD_print("HAL Based", 12, 2);
  LCD_print("Guitar Pedal", 4, THIRD_ROW);
  LCD_drawHLine(1, 5, 84);
  LCD_print("Press a Button", 0, FIFTH_ROW);
  LCD_print("To Continue", 4, SIXTH_ROW);
