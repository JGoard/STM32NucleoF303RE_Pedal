...
# target
######################################
TARGET = STM32NucleoF303RE_GuitarPedal
...
GCC_PATH="C:/USERS/JOSHGOARD/EMBEDDED TOOLCHAINS/ARM-GNU-TOOLCHAIN-12.2.MPACBTI-BET1-MINGW-W64-I686-ARM-NONE-EABI/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/JOSHGOARD/EMBEDDED TOOLCHAINS/OPENOCD-20211118-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/JOSHGOARD/EMBEDDED TOOLCHAINS/OPENOCD-20211118-0.11.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f3x mass_erase 0; exit"
